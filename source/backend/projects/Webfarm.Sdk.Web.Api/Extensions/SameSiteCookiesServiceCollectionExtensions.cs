namespace Webfarm.Sdk.Web.Api.Extensions
{
    ...
    public static class SameSiteCookiesServiceCollectionExtensions
    {
        ...
        private static void CheckSameSite(HttpContext httpContext, [NotNull] CookieOptions options)
        {
        ...
        private static bool DisallowsSameSiteNone([NotNull] string userAgent)
        {
            ...
            if (userAgent.Contains("Chrome/5", StringComparison.InvariantCultureIgnoreCase) ||
                ...
                // todo [as] consider what to do with new chrome. either enforce https or check for localhost + browser
                userAgent.Contains("Chrome/8", StringComparison.InvariantCultureIgnoreCase))
            {
                return true;
            }
