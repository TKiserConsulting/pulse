...
namespace Pulse.Persistence.Migrations
{
    ...
    [Migration("20211122121129_InstructorSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pulse.Data.InstructorSettings", b =>
                {
                    b.Property<Guid>("InstructorId")
                        .HasColumnType("uuid")
                        .HasColumnName("instructor_id");
                    ...
                    b.Property<decimal>("EmoticonTapDelaySeconds")
                        .HasColumnType("numeric")
                        .HasColumnName("emoticon_tap_delay_seconds");
                    ...
                    b.Property<decimal>("SessionTimeoutHours")
                        .HasColumnType("numeric")
                        .HasColumnName("session_timeout_hours");

                    b.HasKey("InstructorId")
                        .HasName("pk_instructor_settings");

                    b.ToTable("instructor_settings");
                });
            ...
            modelBuilder.Entity("Pulse.Data.InstructorSettings", b =>
                {
                    b.HasOne("Pulse.Data.Auth.ApplicationUser", "Instructor")
                        .WithMany()
                        .HasForeignKey("InstructorId")
                        .HasConstraintName("fk_instructor_settings_application_user_instructor_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
